            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Form Add Book</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="writer_name"
                                        ...
                                        placeholder="Enter the Writer writer_Name">
                                    @error('writer_name')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label for="category_id">Category Book
                                    </label>
                                    <select
